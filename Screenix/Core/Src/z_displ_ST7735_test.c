...
void Displ_PerfTest() {
	  ...
	  sprintf(riga,"%ld ms",(long)time[1]);
	  ...
	  sprintf(riga,"%ld ms",(long)time[2]);
	  ...
	  sprintf(riga,"%ld ms",(long)time[3]);
	  ...
	  sprintf(riga,"%ld ms",(long)time[4]);
...
//				sprintf(riga,"INITIAL SETUP: %ld ms",time[k]);
				break;
			case 1:
				sprintf(riga,"STD TEST      %4ld",(long)time[k]);
				break;
			case 2:
				sprintf(riga,"50 SCREENS    %4ld",(long)time[k]);
				break;
			case 3:
				sprintf(riga,"30k H/V LINES %4ld",(long)time[k]);
				break;
			case 4:
				sprintf(riga,"5k CHARS      %4ld",(long)time[k]);
				break;
		}
