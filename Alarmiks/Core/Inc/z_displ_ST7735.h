 ...
 ***************************/
#define DISPL_DMA_CUTOFF 	1

#define RED       0x001F  // Blue channel (5 bits)
#define GREEN     0x07E0  // Green channel (6 bits, unchanged)
#define BLUE      0xF800  // Red channel (5 bits)
#define YELLOW    0x07FF  // Combination of green and blue
#define MAGENTA   0xF81F  // Combination of red and blue
#define CYAN      0xFFE0  // Combination of green and red
#define D_RED     0x0018
#define D_GREEN   0x0600
#define D_BLUE    0xC000
#define D_YELLOW  0x0618
#define D_MAGENTA 0xC018
#define D_CYAN    0xC600
#define DD_RED    0x0010
#define DD_GREEN  0x0400
#define DD_BLUE   0x8000
#define DD_YELLOW 0x0410
#define DD_MAGENTA 0x8010
#define DD_CYAN   0x8400
#define WHITE     0xFFFF  // All channels fully on
#define D_WHITE   0xC618
#define DD_WHITE  0x8410
#define DDD_WHITE 0x4208
#define DDDD_WHITE 0x2104
#define BLACK     0x0000  // All channels off
